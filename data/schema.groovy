...
schema.propertyKey("p_approval_number").Text().create()  // 批准文号
schema.propertyKey("p_component").Text().create()  // 成份
schema.propertyKey("character").Text().create()  // 性状
schema.propertyKey("indication").Text().create()  // 适应症
schema.propertyKey("p_manufacturer").Text().create()  // 生产企业
...
schema.edgeLabel("生产厂商").properties("p_approval_number").connection("drug","manufacturer").create()  // 药物——生产厂商
